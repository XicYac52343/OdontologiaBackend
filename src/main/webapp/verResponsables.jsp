                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>                             
                                    <%                                       
                                        List<claseResponsable> listaResponsables = (List) request.getSession().getAttribute("listaResponsables");
                                    ...
                                    <tr>
                                        ...
                                        <td><%=responsable.getApellidos()%></td>      
                                        <td><%=responsable.getTelefono()%></td>      
                                        <td><%=responsable.getDireccion()%></td>      
                                        <td><%=responsable.getFecha_nac()%></td>         
                                        <td><%=responsable.getTipoResponsable()%></td>       

                                        <td>
                                            <div class="container-fluid d-flex justify-content-center align-items-center h-100" >
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <form action="servletEliminarResponsable" method="POST">
                                                            <p><input type="hidden" name="id" value="<%=responsable.getId()%>"></p>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <form action="servletEditarResponsable" method="GET">
                                                            <p><input type="hidden" name="id" value="<%=responsable.getId()%>"></p>
