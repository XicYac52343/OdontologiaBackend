                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>                             
                                    <%                                       
                                        List<clasePacientes> listaPacientes = (List) request.getSession().getAttribute("listaPacientes");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="container-fluid d-flex justify-content-center align-items-center h-100" >
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <form action="servletEliminarPaciente" method="POST">
                                                            <p><input type="hidden" name="id" value="<%=paciente.getId()%>"></p>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <form action="servletEditarPaciente" method="GET">
                                                            <p><input type="hidden" name="id" value="<%=paciente.getId()%>"></p>
