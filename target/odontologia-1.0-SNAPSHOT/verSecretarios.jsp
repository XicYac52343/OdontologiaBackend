                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>                             
                                    <%                    
                                        List<claseSecretaria> listaSecretarios = (List) request.getSession().getAttribute("listaSecretarias");
                                        for (claseSecretaria secretaria : listaSecretarios) {
                                    %>
                                    <tr>
                                        <td><%=secretaria.getId()%></td>
                                        <td><%=secretaria.getDni()%></td>                            
                                        <td><%=secretaria.getNombre()%></td>
                                        <td><%=secretaria.getApellidos()%></td>      
                                        ...
                                        <td>
                                            <div class="container-fluid d-flex justify-content-center align-items-center h-100" >
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <form action="servletEliminarSecretaria" method="POST">
                                                            <p><input type="hidden" name="id" value="<%=secretaria.getId()%>"></p>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <form action="servletEditarSecretaria" method="GET">
                                                            <p><input type="hidden" name="id" value="<%=secretaria.getId()%>"></p>
                                    ...
                                    <tr>
                                        <td style="text-align: center;">
                                            <a class="btn-outline-sucess"href="altaSecretarias.jsp">
